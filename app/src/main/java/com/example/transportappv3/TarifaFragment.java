 ...
 * Use the {@link TarifaFragment#newInstance} factory method to
...
public class TarifaFragment extends Fragment {
     ...
     * @return A new instance of fragment TarifaFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_tarifaFragment_to_principalFragment);
            }
        });
    }
}